    ...
    const handleAutocompleteChange = (name, value) => {
        ...
        if (Array.isArray(value)) {
            value = value.map(item =>
                item.name || item.ethnicity || item.gender  || item.identity || item
            );
        } else {
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <FormControl variant="outlined" fullWidth>
                                <FormLabel htmlFor="identity_sexuality">Please select the sexual identities that best
                                    describe you
                                    today.</FormLabel>
                                <Autocomplete
                                    multiple
                                    ...
                                    renderOption={(props, option) =>
                                        <li {...props}>{option.name || option.identity}</li>}
                                ...
                                />
                                <FormLabel>
                                    If you see any terms you're not sure about we encourage you to check out this site
                                    to learn more
                        ...
                        <Grid item xs={12}>
                            <FormControl variant="outlined" fullWidth>
                                <FormLabel htmlFor="identity_gender">Please select the gender identities that best
                                    describe you
                                    today.</FormLabel>
                                <Autocomplete
                        ...
                        <Grid item xs={12}>
                            <FormControl variant="outlined" fullWidth>
                                <FormLabel htmlFor="identity_ethic">Please select all the identities that best describe
                                    your ethic
                                ...
                                <Autocomplete
                                    ...
                                    renderOption={(props, option) =>
                                        <li {...props}>{option.name || option.ethnicity}</li>}
                        ...
                        <Grid item xs={12}>
                            <FormControl variant="outlined" fullWidth>
                                <FormLabel htmlFor="c">Have you ever identified yourself as someone with a
                                    disability?
                                    Both visible and non-visible disabilities included.</FormLabel>
                                <Select id="disability"
                                        name="disability"
                                        onChange={handleSelectChange}
                                        value={identityFormData.disability}>
                        ...
                        <Grid item xs={12}>
                            <FormControl variant="outlined" fullWidth>
                                ...
                                <Select onChange={handleSelectChange}
                                        name="care_giver"
                                        value={identityFormData.care_giver} id="care_giver">
                                    <MenuItem value="true">Yes</MenuItem>
                                    <MenuItem value="false">No</MenuItem>
                                    <MenuItem value="Prefer not to answer">Prefer not to answer</MenuItem>
                                </Select>
                        ...
                        <Grid item xs={12}>
                            <FormControl variant="outlined" fullWidth>
                                ...
                                <Select onChange={handleSelectChange}
                                        name="veteran_status"
                                        value={identityFormData.veteran_status}
                                        id="veteran_status">
                                    <MenuItem value="1">I am not a protected veteran</MenuItem>
                                    <MenuItem value="2">I identify as one or more of the classifications of a protected
                                        veteran</MenuItem>
