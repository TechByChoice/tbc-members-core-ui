...
export default function ProfileInterests({handleChange, questions}) {
    ...
    return (
        <>
            <Grid container>
                <Grid item xs={12}>
                    <Typography variant="h6">Skills & Roles</Typography>
                    <hr/>
                </Grid>
                            ...
                            <FormControl fullWidth error={!!formErrors.job_department}>
                                ...
                                <Autocomplete
                                    ...
                                    renderInput={(params) => <TextField
                                        name="job_department" {...params} />}
                                />
                                {!!formErrors.job_department &&
                                    <FormHelperText>{formErrors.job_department}</FormHelperText>}
                            </FormControl>
                        </Grid>
