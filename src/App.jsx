                    ...
                    <Container>
                        <Routes>
                            ...
                            <Route exact path="/profile" element={<PrivateRoutes
                                userDetail={user || undefined}><ProfileSettingPage/></PrivateRoutes>}/>
                            ...
                            <Route exact path="/member/:id"
                                   element={<ViewMemberProfile isLoading={isLoading} userDetail={user?.[0]}/>}/>
                            <Route exact path="/mentor/create"
                                   element={<NewMentorPage isLoading={isLoading} userDetail={user?.[0]}/>}/>
                            <Route exact path="/mentor/all"
                                   element={<AllMentorsPage isLoading={isLoading} userDetail={user?.[0]}/>}/>
                        </Routes>
                    </Container>
                </BrowserRouter>
            </StatusProvider>
