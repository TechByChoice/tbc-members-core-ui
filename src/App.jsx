                        ...
                        <BrowserRouter>
                            ...
                            <Container id="mainContent">
                                <Routes>
                                    ...
                                    />
                                    <Route path="/job/:id" element={<ViewJobPage isLoading={false} userDetail={user?.[0]} />} />
                                    <Route path="/company/:id" element={<ViewCompanyPage isLoading={false} userDetail={user?.[0]} />} />
